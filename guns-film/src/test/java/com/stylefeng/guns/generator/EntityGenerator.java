...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("/Users/coapeng/IdeaProjects/githubOpenSource/guns/guns-film/src/main/java");//这里写你自己的java目录
       ...
       // strategy.setExclude(new String[]{"mooc_banner_t","mooc_cat_dict_t","mooc_area_dict_t","mooc_year_dict_t","mooc_film_t","mooc_film_info_t","mooc_actor_t"});
       // strategy.setExclude("mooc_user_t");
